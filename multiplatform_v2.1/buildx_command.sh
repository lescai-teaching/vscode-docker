...
--label org.opencontainers.image.source=https://github.com/lescai-teaching/vscode-docker --label org.opencontainers.image.version=5.0.1 \
--label org.opencontainers.image.created=2023-07-19T12:39:11.393Z \
--label org.opencontainers.image.licenses=MIT \
--platform linux/amd64,linux/arm64 \
--tag ghcr.io/lescai-teaching/vscode-docker:5.0.1 \
